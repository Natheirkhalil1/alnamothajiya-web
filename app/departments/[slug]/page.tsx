                  ...
                  {displayedSubsections.map((subsection, index) => {
                    ...
                    return (
                      <div key={index} className="space-y-12">
                        <Card className="overflow-hidden shadow-2xl rounded-3xl border-2 border-gray-200 dark:border-gray-800 hover:border-primary/50 transition-all duration-500">
                          <div className="grid md:grid-cols-2 gap-0">
                            ...
                            <div className="relative h-[500px] md:h-auto overflow-hidden group">
                              ...
                              {/* Floating icon badge */}
                              <div
                                className={`absolute top-8 ${language === "ar" ? "right-8" : "left-8"} p-6 bg-gradient-to-br ${department.color} rounded-3xl shadow-2xl hover:scale-110 hover:rotate-6 transition-all duration-500 group-hover:shadow-3xl`}
                              >
                                <SubIcon className="w-12 h-12 text-white" />
                              </div>

                              {/* Decorative elements */}
                              <div className="absolute bottom-8 left-8 w-24 h-24 bg-white/10 rounded-full blur-2xl animate-pulse-slow" />
                              <div className="absolute top-1/2 right-8 w-32 h-32 bg-primary/20 rounded-full blur-3xl animate-float-delayed" />
                            </div>

                            {/* Description Section - Right Side */}
                            <div className="p-10 md:p-12 flex flex-col justify-center bg-gradient-to-br from-white via-gray-50/50 to-white dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900 relative overflow-hidden">
                              ...
                              <div className="relative z-10 space-y-6">
                                ...
                                <div>
                                  <div className="flex items-center gap-4 mb-4">
                                    <div className={`h-1 w-16 bg-gradient-to-r ${department.color} rounded-full`} />
                                    <Badge
                                      className={`bg-gradient-to-r ${department.color} text-white border-0 px-4 py-1 text-sm font-semibold`}
                                    >
                                      {language === "ar" ? "قسم متخصص" : "Specialized Section"}
                                    </Badge>
                                  </div>

                                  <h3 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent mb-4 leading-tight">
                                    {language === "ar" ? subsection.titleAr : subsection.titleEn}
                                  </h3>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-3 pt-4">
                                  <div className="flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full border border-primary/20">
                                    ...
                                    <span className="text-sm font-semibold text-primary">
                                      {language === "ar" ? "خدمة متميزة" : "Premium Service"}
                                    </span>
                                  </div>
                                ...
                                <div className="pt-6">
                                  <Button
                                    onClick={handleContactClick}
                                    className={`bg-gradient-to-r ${department.color} hover:opacity-90 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 px-8 py-6 text-lg rounded-full group`}
                                  >
                                    <Phone
                                      className={`w-5 h-5 ${language === "ar" ? "ml-2" : "mr-2"} group-hover:rotate-12 transition-transform`}
                                    />
                                    <span>{language === "ar" ? "استفسر عن هذه الخدمة" : "Inquire About Service"}</span>
                                    <ArrowIcon
                                      className={`w-5 h-5 ${language === "ar" ? "mr-2" : "ml-2"} group-hover:translate-x-1 transition-transform`}
                                    />
                                  </Button>
                                </div>
                              </div>
